...
//  }
    ...
    public void getFilesName() {
        try {
            ...
            FTPFile[] files = ftp.listFiles("/home");
    ...
    //下载文件的第二种方法，优化了传输速度
        public void getFile2() {
            try {
                InputStream is = ftp.retrieveFileStream("/home/voucher/deploy.zip");

                FileOutputStream fos = new FileOutputStream(new File("E:\\/upload"));
    ...
    public static void main(String args[]) {
        Ftp1 m = new Ftp1("10.125.49.181",22,"voucher","voucher!Q2w");
